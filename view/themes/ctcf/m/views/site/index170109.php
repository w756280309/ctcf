    ...
    <div class="container flex-content relative">
        ...
        <div class="shareholder">
            ...
            <ul>
                <li></li>
                <li>
                    <img data-original="<?= ASSETS_BASE_URI ?>images/ctcf/logo1.png" alt="">
        ...
        <div class="address" style="height: 2rem;">
            <a class="f14" href="tel:<?= Yii::$app->params['platform_info.contact_tel'] ?>"><img data-original="<?= FE_BASE_URI ?>wap/index/images/phone.png" alt=""><?= Yii::$app->params['platform_info.contact_tel'] ?>（<?= Yii::$app->params['platform_info.customer_service_time'] ?>）</a>
            <p class="f14">湖北省武汉市东湖路181号楚天文化创意产业园8号楼1层</p>
        </div>

        <footer class="f11"><span></span>湖北日报新媒体集团旗下<span></span></footer>
