...
$contactTime = Yii::$app->params['platform_info.customer_service_time'];
...
<section>
    ...
    <div class="content">
        ...
        <ul>
            ...
            <li>方法二：线下客户拨打客服热线<a href="tel:<?= $contactTel ?>"><?= $contactTel ?></a>（<?= $contactTime ?>）查询您当前个人的积分数量。</li>
        </ul>
        ...
        <ul>
            ...
            <li>礼品一旦兑换成功不能更改，积分兑换礼品后请在30天内前来领取，逾期作废，如有问题请联系客服人员：<a href="tel:<?= $contactTel ?>"><?= $contactTel ?></a>（<?= $contactTime ?>）。</li>
            <li>不同账户积分不可合并使用。</li>
        </ul>
