    ...
    <?php } else { ?>
        ...
        <div class="note">
            <ul>
                ...
                <li>如需要大额充值，可选择PC官网进行网银充值，地址（www.hbctcf.com），如有疑问，请联系客服<a class="contact-tel" href="tel:<?= Yii::$app->params['platform_info.contact_tel'] ?>"><?= Yii::$app->params['platform_info.contact_tel'] ?></a>。</li>
            </ul>
        </div>
