...
$contact = Yii::$app->params['platform_info.contact_tel'].'（'.Yii::$app->params['platform_info.customer_service_time'].'）';
    ...
    <div class="rule_content">
        ...
        <div class="item_box">
            ...
            <ul class="box_content">
                <li>认购理财产品：</li>
                <li>认购楚天财富理财产品（新手专享标、理财计划、转让的项目不参加）均会产生积分：</li>
        ...
        <div class="item_box">
            ...
            <ul class="box_content">
                ...
                <li>方法二：线下客户拨打客服热线<?= $contact ?>查询您当前个人的积分数量。</li>
            </ul>
        </div>
        <div class="item_box">
            <p class="box_title">
            ...
            <ul class="box_content">
                ...
                <li>礼品一旦兑换成功不能更改，积分兑换礼品后请在30天内前来领取，逾期作废，如有问题请联系客服人员：<?= $contact ?></li>
                <li>不同账户积分不可合并使用</li>
            </ul>
        </div>
        <div class="item_box">
