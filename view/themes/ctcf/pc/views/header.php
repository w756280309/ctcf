...
<div id="header-top-box">
    <div class="header-top-box">
        <div class="header-top-left">
            <span>客服热线：<?= Yii::$app->params['platform_info.contact_tel'] ?>（<?= Yii::$app->params['platform_info.customer_service_time'] ?>）</span>
        </div>
    ...
    <div class="header-nav-box">
        <a href="/">
            <div class="header-logo">
                <img src="<?= ASSETS_BASE_URI ?>images/ctcf/logo.png" alt="">
            </div>
        </a>
        <div class="header-nav">
            <ul>
                <li><a class="<?= 'site/index' === $action ? 'header-nav-click' : '' ?>" href="/">首页</a></li>
                <li><a class="<?= 'licai/index' === $action || 'licai/notes' === $action ? 'header-nav-click' : '' ?>" href="/licai/">我要理财</a></li>
