...
<div class="more-box ">
    <div class="more-box-left">
        ...
        <ul class="more-right-bottom title-ellipsis">
            ...
            <li><a href="/helpcenter/security/" target="_blank">为什么在楚天财富投资是安全的？</a></li>
            <li><a href="/helpcenter/background/" target="_blank">了解楚天财富。</a></li>
...
<div class="background-box">
    ...
    <div class="background-bottom">
        <div class="background-left">
            <img src="<?= ASSETS_BASE_URI ?>images/ctcf/logo1.png" alt="">
        </div>
