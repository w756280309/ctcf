        ...
        <div class="rightcontent">
            ...
            <div class="help-box">
                ...
                <div class="kong-width">
                    ...
                    <p>用户登录后，进入【我的账户】-&gt;【提现】-&gt;点击“提现”按钮，按照提示完成提现操作。</p>
                    <p class="single-tuchu">9、提现是否有限额？
                    </p>
                    <p>提现每日最高100万，超过100万需要临时提升限额或分多日提现，如需提升限额请联系客服，电话<?= Yii::$app->params['platform_info.contact_tel'] ?>。
                    </p>

                    <p class="single-tuchu">10、提现多久可以到账？</p>
                    <p>提现时间为T+1个工作日到账，如遇周末及节假日顺延。</p>

                    <p class="single-tuchu">11、充值提现是否收取手续费？</p>
                    <p>为提高用户资金流动性，楚天财富网目前暂不对用户收取充值、提现手续费。</p>
                </div>
            </div>
        </div>
        <div class="clear"></div>
