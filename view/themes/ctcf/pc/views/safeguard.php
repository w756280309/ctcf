...
<div class="safeguard-box clearfix">
    <div class="safeguard-banner">
        <div class="banner" style="background: url(<?= ASSETS_BASE_URI ?>images/ctcf/safeguard-banner.png) no-repeat center center;"></div>
    </div>
            ...
            <div class="safeguard-icons">
                ...
                <div class="safetxt">
                    <div class="safetxt-icon ">
                        ...
                        <h4>（1）对接专业机构产品</h4>
                        <p class="p-padding-lf">楚天财富理财的产品主要为各类金融机构、政信类金融产品，国有平台挂牌金融资产项目，并有多重还款保障，安享稳健高收益。</p>

                        <h4>（2）坚持合法合规运营</h4>
                        <p class="p-padding-lf">楚天财富恪守各级金融监管部门的监管要求，上线之初严格要求，坚持合法合规运营，是专业的金融理财产品服务平台。</p>
                        ...
                        <h4>（4）股东背景强势</h4>
                        <p class="p-padding-lf">楚天财富（简称楚天财富）由湖北日报新媒体集团、南京金融资产交易中心等股东构成，其强大的媒体公信力、专业的金融机构背景，助力楚天财富全力发展互联网金融业务，给予楚天财富理财更长足的发展动力。</p>
                    </div>

                    <div class="safetxt-icon hide">
                        <h3>楚天财富理财的风控先进在哪？</h3>
                        <p class="p-margin-top ">楚天财富平台自身不生产资产。获取资产的方式是通过股东资源、合作机构、团队专业性等多重维度，筛选第三方优质资产方以拓展资产端资源，将其做好风控的项目或标的放到平台上与投资者对接。这些资产方包括南京金融资产交易中心、银行类理财产品、优质企业政信类产品等优质债权提供方。</p>
                    </div>
                    ...
                    <div class="safetxt-icon hide">
                        ...
                        <p class="p-margin-top">楚天财富联手易保全电子数据保全中心，为投资者提供交易凭证保全服务，交易凭证（担保函、担保合同等信息）一旦保全，其内容、生成时间等信息将被加密固定，且生成唯一的保全证书供下载。事后任何细微修改，都会导致保全证书函数值变化，有效防止人为篡改。如发生司法纠纷，保全证书持有人，可以通过易保全电子数据保全中心提供的认证证书向法院或仲裁机构提供有效、可靠的证据，从而获得举证的优势地位。</p>
