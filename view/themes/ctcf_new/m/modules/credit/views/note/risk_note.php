    ...
    <div class="container bootstrap-common helpcenter_login_resister">
        <div class="kong-width">
            <div class="row single">
                ...
                <p><b>以上并不能揭示您投资本产品的全部风险及市场的全部情形。您在受让前，务必认真阅读转让规则、转让协议以及本产品的产品说明书、认购协议、本风险揭示书等法律文件的全部内容，理解、掌握本产品的特点和所有条款规则，并通过楚天财富网站、交易终端所公布的信息及其他相关公告了解拟投资产品的风险收益特征，确保投资金额占用您可支配收入总额的合理份额，根据自身的风险承受能力和资产状况等谨慎决策，自行承担全部风险。如影响您风险承受能力的因素发生变化，请及时联系楚天财富更新您的风险承受能力评估结果。</b></p>
            </div>
        </div>
    </div>
<?php } ?>