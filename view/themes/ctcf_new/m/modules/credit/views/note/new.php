...
<div class="row produce">
    ...
    <div class="col-xs-4 col-xs-offset-1">可转让金额</div>
    <div class="col-xs-7 text-align-lf col"><?= number_format(bcdiv($asset['maxTradableAmount'], 100, 2), 2)?>元</div>
    <div class="col-xs-4 col-xs-offset-1">借贷双方约定利率</div>
    <div class="col-xs-7 text-align-lf col">
        <?= floatval($apr) * 100 ?>%
    </div>
    <div class="col-xs-4 col-xs-offset-1">剩余期限</div>
    <div class="col-xs-7 text-align-lf col">
        <?php
