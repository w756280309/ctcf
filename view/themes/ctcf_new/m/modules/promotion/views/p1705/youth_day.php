...
<div class="flex-content">
    ...
    <div class="part-two">
        <img src="<?= FE_BASE_URI ?>wap/campaigns/Youth-day/images/gift_show.png" alt="" class="gift-show">
        <img src="<?= FE_BASE_URI ?>wap/campaigns/Youth-day/images/gift_one.png" alt="" class="gift-pic gift-one">
        <img src="<?= FE_BASE_URI ?>wap/campaigns/Youth-day/images/gift_two.png" alt="" class="gift-pic gift-two">
        <img src="<?= FE_BASE_URI ?>wap/campaigns/Youth-day/images/gift_three.png" alt="" class="gift-pic gift-three">
        <img src="<?= FE_BASE_URI ?>wap/campaigns/Youth-day/images/gift_four.png" alt="" class="gift-pic gift-four">
    </div>
    ...
    <div class="part-four">
        ...
        <p class="attention">本次活动最终解释权归温都金服所有</p>
