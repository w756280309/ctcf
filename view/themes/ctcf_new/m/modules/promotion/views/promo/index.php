...
<div class="container flex-content" id="scrolltop">
    ...
    <?php if ('carshow11' === $promo->key) { ?>
        <div class="newnorm">
            <p class="newnormtitle f15">楚盈恒<span class="f12">武汉项目</span><span class="f12">民生工程</span></p>
            <a href="/issuer?id=19">
                <p class="f15">楚盈恒-(2017010296)102601</p>
                <p class="f45"><em>7.5～8<i class="f25">%</i><span class="f15"></span></em></p>
                <p class="f12">借贷双方约定利率</p>
                <ul class="clearfix">
                    <li class="f14 lf text-align-lf"><img class="icon5"  data-original="<?= FE_BASE_URI ?>wap/luodiye/images/icon_05.png" alt=""> 100,000起借</li>
                    <li class="f14 lf comred"><img class="icon6"  data-original="<?= FE_BASE_URI ?>wap/luodiye/images/icon_06.png" alt=""> 18月出借期限</li>
    ...
    <div class="choosereason2">
        ...
        <div class="shareholder">
            ...
            <ul>
                <li></li>
                <li class="f15" style="color: #333333;text-align: left;">楚天财富是隶属湖北日报新媒体集团旗下的出借平台。甄选各类金融机构、优质企业产品。提供银行级出借服务，保障用户资金，安享稳健收益。</li>
            </ul>
        </div>
    ...
    <div class="bottomside">
        ...
        <dl>
            ...
            <div class="clearfix">
                ...
                <p class="lf">
                    <a class="f15" href="tel:400-101-5151" style="line-height:0.6266667rem;"><?= Yii::$app->params['platform_info.contact_tel'] ?></a>
