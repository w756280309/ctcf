...
<link rel="stylesheet" href="<?= FE_BASE_URI ?>wap/campaigns/active20170527/css/share.css?v=2.0">
...
<div class="flex-content">
    ...
    <div class="content">
        ...
        <div class="gifts clearfix">
            <img class="lf" src="<?= FE_BASE_URI ?>wap/campaigns/active20170527/images/shareGift_01_two.png" alt="">
        ...
        <div class="relay clearfix">
            <img class="relayDo lf" src="<?= FE_BASE_URI ?>wap/campaigns/active20170527/images/share_do_two.png" alt="">
            <a class="rg" href="/promotion/p170617/">
...
<script>
    $(function() {
        ...
        $(".relayDo").on("click",function(e) {
            ...
            var xhr = $.get('/promotion/p170617/support', {id: calloutId});
            allowClick = false;
