        ...
        <div class="publisher">
            ...
            <div class="pubcontent">
                ...
                <div>
                    ...
                    <span>贵州省三都水族自治县国有资本营运有限责任公司于2001年7月经县人民政府批准筹建，注册资本1200万元。公司承担政府出借项目融资功能，满足基础设施和城镇化建设融资需要，2014年8月增至30亿元。截止2015年10月公司资产合计346,576万元，净资产308,439万元。</span>
                </div>
            </div>
        </div>
        <div class="guarantor">
            ...
            <div class="guacontent">
                <h5>三都水族自治县民族文化旅游出借开发有限责任公司</h5>
                <div>
                    <img src="<?= FE_BASE_URI ?>wap/introduce/img/project_04.png" alt="">
                    <span>三都水族自治县民族文化旅游出借开发有限责任公司于2002年成立，法人代表韦景跃，注册资本31,030 万人民币，企业性质为有限责任公司(国有控股)。</span>
                </div>
            </div>
        </div>
        <?php if ($issuer->video) { ?>
        ...
        <div class="guarantor">
            ...
            <div class="guacontent">
                ...
                <div>
                    ...
                    <span>泰州市海润国有资产经营有限公司成立于2001年9月26日，注册资本为人民币2,5000万元，是地方    政府平台上国资背景的公司，其母公司泰州海陵资产经营有限公司注册资本20.7亿元，主体评级AA，是国有独资有限责任公司。由海陵区房改办、市路灯管理处作为出借主体，是海陵区主要投融资平台和基础设施建设主体，得到当地政府大力支持。</span>
                </div>
            </div>
        </div>
        <?php if ($issuer->video) { ?>
...
<?php } elseif (3 === $issuerId) { ?>
    ...
    <section>
        <div class="publisher pub-special">
            ...
            <div class="pubcontent">
                ...
                <div>
                    ...
                    <span>北大青鸟集团紧密依托北京大学优良、丰富的资源，以创新求发展，目前已形成包括IT（及制造业）、教育、文化传媒、地产、新能源、旅游、金融在内的七大产业，旗下拥有数十家企业，员工近万余名，资金雄厚，业务范围遍及全国20多个主要城市，资本运营力度较大、出借回报较为显著。</span>
                </div>
            </div>
        </div>
        <div class="guarantor">
        ...
        <div class="publisher">
            ...
            <div class="pubcontent">
                <h5>校办企业国企担保</h5>
                <div>
                    <span>北京北大科技实业发展中心向发行人出具《担保函》，约定为本定向融资工具本金及利息的到期偿付提供全额无条件不可撤销的连带责任保证担保。保证范围为本定向融资工具的本金及出借收益，以及违约金、损害赔偿金、实现债权的费用和其他应支付的费用；保证期间为本定向融资工具存续期及本定向融资工具到期日起二年。</span>
                </div>
            </div>
        </div>
        <div class="publisher">
            ...
            <p><span><i></i></span></p>
            <div class="pubcontent">
                <h5>北京北大高科技产业出借有限公司</h5>
                <div>
                    <span>北京北大高科技产业出借有限公司是由广州北大青鸟商用信息系统有限公司、北京东方国兴科技发展有限公司、北京北大博雅出借有限公司共同出资组建的有限责任公司。</span>
                    <span>注册资本7.8亿公司是一家依托北京大学和北大青鸟集团从事教育产业、计算机及制造业、旅游产业及金融产业专业出借和主动管理的企业。</span>
    ...
    <footer>
        <table>
            <tr>
                <td class="lf">发行人</td>
                <td class="rg">北京北大高科技产业出借有限公司</td>
            </tr>
            <tr>
                <td class="lf">备案登记机构</td>
                <td class="rg">南京金融资产交易中心有限公司</td>
...
<?php } elseif (10 === $issuerId) { ?>
    ...
    <section>
        <div class="publisher pub-special">
            ...
            <p><span><i></i></span></p>
            <div class="pubcontent">
                <h5>中科建飞出借控股集团有限公司</h5>
                <div>
                    <span>中科建飞出借控股集团有限公司（简称“中科建飞”）是中科建设开发总公司的全资子公司，成立于2015年1月23日，注册资本1亿元，是公司发展出借业务的主要平台，致力于打造金融与资本运作的平台，对外经营房地产开发、实业出借、创业出借、建筑专业设计、市场营销策划等。截至2016年3月，货币资金4亿，总资产64.27亿，净资产13.97亿，净利润11.54亿，现金流余额1.26亿。</span>
                </div>
            </div>
        </div>
        <div class="publisher">
            ...
            <div class="pubcontent">
                <h5>中科建设开发总公司</h5>
                <div>
                    <span>中科建设开发总公司是国家一级央企，由中科院100%控股公司。其前身为中国人民解放军军事科学院工程局，1999年军企改革，划归于中国科学院管理，系军转地性质的建设开发综合性企业。公司长期从事部队营房建造、国防建设和国家重点项目建设，经过多年的出色经营，凭借高超的施工能力、丰富的施工经验和优良的施工质量，取得了骄人的业绩，在军内外享有上佳的口碑。</span>
                    <span>2015年末该公司合并总资产123.73亿元，总公司在建设项目超过600亿，预计在16年到17年，建筑施工板块预计可为中科建带来超过300亿的主营业务收入，中诚信对该公司的信用评级为AA。</span>
                    <span>近三年来该公司产值成倍增长，利税近十亿，并以20%的速度递增。系多板块经营的及为城市发展建设提供整体方案和一体化服务的大型国有出借建设集团。</span>
                </div>
            </div>
        </div>
        <div class="guarantor">
    ...
    <footer>
        <table>
            ...
            <tr>
                <td class="lf" style="line-height: 1rem;">收益分配</td>
                <td class="rg" style="line-height: 0.6rem; padding-top: 0.2rem;padding-bottom: 0.2rem;text-align: right;">每一个自然季度付息一次，到期偿还<br>出借本金及最后一笔利息</td>
            </tr>
        </table>
        <?php if ($loansCount) { ?>
            <a href="/issuer/to-loan?issuerid=<?= $issuerId ?>">立即认购</a>
