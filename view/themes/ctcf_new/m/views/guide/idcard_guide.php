...
<style>
    body{background-color:#fff}.section-one{padding:.66666667rem 2.66666667% 1.2rem}.section-one img{width:2.13333333rem;display:block;margin:0 auto}.section-one h5{font-size:.48rem;color:#434a54;text-align:center;line-height:1;margin:.56rem 0}.section-one p{width:85%;font-size:.37333333rem;color:#434a54;line-height:.45333333rem;margin:0 auto}.section-two{padding:0 .26666667rem;overflow:hidden}.section-two ul{padding:0 .8rem;width:100%;border:1px solid #ededed;box-shadow:1px 1px 5px #eaeaea;margin-bottom:.26666667rem;border-radius:.13333333rem}.section-two ul li{padding:1rem 0;line-height:.58666667rem;font-size:.48rem;color:#aab2bd}.section-two ul li img{width:.58666667rem;margin:0 .73333333rem 0 .36rem;position:relative;top:-.05rem;left:0}.section-two ul li span.rg{display:block;width:45%}.section-two ul li:first-child{color:#ff6707;border-bottom:1px solid #aab2bd}.go-realName{display:block;text-align:center;border-radius:.13333333rem;color:#fff;font-size:.50666667rem;line-height:1.17333333rem;background-color:#ff6707;height:1.17333333rem;width:100%}.tips{color:#aab2bd;font-size:.37333333rem;line-height:1rem}.go-out{text-decoration:underline;font-size:.37333333rem;color:#ff6707;line-height:1;text-align:center;margin-bottom:.8rem}.popover{display:none;width:80%;position:absolute;top:50%;left:50%;z-index:100001;transform:translate(-50%,-50%);-webkit-transform:translate(-50%,-50%);-moz-transform:translate(-50%,-50%);border-radius:.35rem;height:5.06666667rem;background-color:#fff}.popover p{padding:1.33333333rem 1rem;color:#aab2bd;font-size:.37333333rem;line-height:.53333333rem}.popover dl{position:absolute;bottom:0;left:0;height:1.36rem;line-height:1.33333333rem;width:100%;border-top:.02666667rem solid #ddd;font-size:.42666667rem;color:#434a54;text-align:center}.popover dt{width:50%}.popover dd{width:50%;color:#f03745;border-left:1px solid #ddd}
</style>
<div class="flex-content">
    ...
    <div class="section-two">
        <ul>
            <li>
                <img src="<?= ASSETS_BASE_URI ?>ctcf/images/guide-realName/checked.png" alt="">
                <span>第1步</span>
