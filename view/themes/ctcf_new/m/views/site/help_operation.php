...
<div class="container bootstrap-common helpcenter_login_resister">
    ...
    <div class="kong-width">
        <div class="row single">
            ...
            <p>用户可以编辑短信“GGMM#原密码#新密码”发送给联动优势来更改密码。例如编辑发送短信“GGMM#123456#234567”，交易密码只能是6位数字。联动优势短信号码：移动用户编辑短信发送至10690569687;电信用户编辑短信发送至106901974687;联通用户编辑短信发送至106911535687。
    ...
    <div class="kong-width">
        <div class="row single">
            ...
            <p>可以绑定工商银行、农业银行、建设银行、中国银行、浦发银行、交通银行、广发银行、中信银行、光大银行、兴业银行、招商银行、平安银行等银行卡。
    ...
    <div class="kong-width">
        <div class="row single">
            ...
            <p style="margin-top: 0">对于发行人不能提前还款类的产品，付息日和还款日前3天不可转让。对于发行人可提前还款类的产品，付息日前3天不可转让，还款日前13天不可转让。
            ...
            <p class="single-tuchu">11、提现手续费怎么收取？
            <p>为提高用户资金流动性，楚天财富网目前暂不对用户收取充值、提现手续费。
        </div>
    </div>
</div>