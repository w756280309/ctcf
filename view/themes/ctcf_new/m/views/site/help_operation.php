...
<div class="container bootstrap-common helpcenter_login_resister">
    ...
    <div class="kong-width">
        <div class="row single">
            ...
            <p>注册楚天财富账户时无需进行实名认证。但是开通第三方资金托管平台（联动优势）账户时，需对用户实名身份认证，用户真实身份在该平台一经核实，不能修改。
    ...
    <div class="kong-width">
        <div class="row single">
            ...
            <p>用户可以编辑短信“GGMM#原密码#新密码”发送给联动优势来更改密码。例如编辑发送短信“GGMM#123456#234567”，交易密码只能是6位数字。<br><strong>联动优势短信号码：</strong><br>移动用户编辑短信发送至106903125212687;<br>电信用户编辑短信发送至106901974687;<br>联通用户编辑短信发送至106911535687。
    ...
    <div class="kong-width">
        <div class="row single">
            ...
            <p style="margin-bottom: 0">认购期限为180天（不含）以上的项目持有30天后即可进行转让；持有天数从计息日开始计算；
