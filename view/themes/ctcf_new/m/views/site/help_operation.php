...
<div class="container bootstrap-common helpcenter_login_resister">
    ...
    <div class="kong-width">
        <div class="row single">
            ...
            <p>注册楚天财富账户时无需进行实名认证。但是开通第三方支付平台（联动优势）账户时，需对用户实名身份认证，用户真实身份在该平台一经核实，不能修改。
    ...
    <div class="row">
        <p class="header"><span>——————</span>&nbsp;开通第三方支付&nbsp;<span>——————</span></p>
    </div>
    <div class="kong-width">
        <div class="row single">
            <p class="single-tuchu">1、为什么要开通第三方支付账户？
            <p>楚天财富接入了联动优势电子商务有限公司的第三方支付系统，实现了平台对个人及企业用户的账户进行独立管理，交易仅限用户本人操作，资金安全有保障。

            <p class="single-tuchu">2、如何开通第三方支付账户？
            <p>用户完成注册后，点击相应页面进行充值，系统将自动引导开通第三方支付账户，根据提示完成相应操作即可。

            <p class="single-tuchu">3、如何查看第三方支付支付密码？
            <p>在首次开通支付账户时，联动优势会以短信的形式将初始密码发送到开户人绑定的手机。

            <p class="single-tuchu">4、如何更改第三方支付支付密码？
            <p>用户可以编辑短信“GGMM#原密码#新密码”发送给联动优势来更改密码。例如编辑发送短信“GGMM#123456#234567”，交易密码只能是6位数字。<br><strong>联动优势短信号码：</strong><br>移动用户编辑短信发送至106901336553687;<br>电信用户编辑短信发送至106901337;<br>联通用户编辑短信发送至106906067。
            <p class="single-tuchu">5、忘记第三方支付支付密码如何重置？
            <p>用户可以通过网站重置支付密码。用户进入【账户】->【设置】->【安全中心】->【修改交易密码】，点击“重置支付密码”，系统会自动为您重置联动优势支付账户密码，并通过短信发送到您手机。
            <p style="margin-bottom: 0">用户也可以编辑短信“CSMM#身份证后四位”发送给联动优势来重置密码。例如身份证号是110*******11055425，编辑发送短信“CSMM#5425”。（ 请注意：CSMM不区分大小写，但是大小写要求一致；用户身份证最后一位为字母X的情况，用户编辑短信最后一位字母大小写必须与注册时相符，否则无法重置成功。）
    ...
    <div class="kong-width">
        <div class="row single">
            ...
            <p style="margin-bottom: 0">出借期限为180天（不含）以上的项目持有30天后即可进行转让；持有天数从计息日开始计算；
          对于发行人不能提前还款类的产品，付息日和还款日前3天不可转让。对于发行人可提前还款类的产品，付息日前3天不可转让，还款日前13天不可转让。
