...
<div class="container relation" >
    ...
    <div class="about-content row">
        <div class="xinxi"><p class="p_float">公司地址&nbsp;:</p><p class="p_num">武汉市武昌区东湖路181号楚天文化创意产业园区1号楼6层</p></div>
        <div class="xinxi"><p class="p_float">工作时间&nbsp;:</p><p class="p_num">9:00-17:30 （周一至周五） </p></div>
