    ...
    <?php $this->beginBody() ?>
        <div class="container bg_color">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <p class="content">
                        楚天财富联手易保全电子数据保全中心，为出借者提供交易凭证保全服务，交易凭证（担保函、担保合同等信息）一旦保全，其内容、生成时间等信息将被加密固定，且生成唯一的保全证书供下载。事后任何细微修改，都会导致保全证书函数值变化，有效防止人为篡改。如发生司法纠纷，保全证书持有人，可以通过易保全电子数据保全中心提供的认证证书向法院或仲裁机构提供有效、可靠的证据，从而获得举证的优势地位。
                    </p>
                </div>
            </div>
            <!-- 1、title-->
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <p class="content">
                        A：出借者拿到保全证书后，可以登录www.ebaoquan.org，录入证书上的备案号及上传被保全文件（如电子合同）进行真伪验证，或者从收到证书生成的邮件中，点击“查看我的保全证书”，进入证书页面使用验证功能。
                    </p>
                    <p class="content content-subtitle">
                        Q：电子数据保全是否具有法律效力？
                    </p>
                    ...
                    <p class="content">
                        A：相较传统取证手段，电子数据保全具有低成本、高效率、保密（系统仅仅在本地生成数据的数字摘要，绝无泄露隐私、商业秘密、内容的风险！）合法、权威等优势，并且可以通过事先存证来预防和化解纠纷，是互联网出借者保护交易证据安全的首选。
                    </p>
                    <p class="content">
