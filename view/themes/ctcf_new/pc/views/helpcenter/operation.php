        ...
        <div class="rightcontent">
            ...
            <div class="help-box">
                ...
                <div class="kong-width">
                    ...
                    <p>作为用户在楚天财富网平台和第三方资金托管账户重要的识别信息，手机号码无法进行变更。请用户妥善保管注册时使用的手机号码。

                    </p>
                    <p class="single-tuchu">4、注册个人用户时需要进行实名认证吗？
                    </p>
                    <p>注册楚天财富网账户时不需要对用户进行实名认证。但是当用户开通第三方资金托管平台（联动优势）账户时，需对用户进行实名身份认证，用户真实身份在该平台一经核实，不能修改。

                    </p>
                    <p class="single-tuchu">5、如何更改登录密码？
                    </p>
                    <p>登录楚天财富网账户，用户进入【账户】-&gt;【设置】-&gt;【安全中心】-&gt;点击修改登录密码，按相关提示设置新密码即可。
                ...
                <div class="kong-width">
                    ...
                    <p>楚天财富网接入了联动优势电子商务有限公司的资金托管系统，实现了平台对个人及企业用户的账户进行独立管理，交易仅限用户本人操作，资金安全有保障。
                ...
                <div class="kong-width">
                    ...
                    <p>进入楚天财富网“账户中心－我的转让－可转让的项目”，进行转让操作；转让方在转让时，可以进行折价处理，折价比例在0%～3%之间，但折让后价格不可低于转让金额。
                    </p>
