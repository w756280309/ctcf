    ...
    <ul>
        ...
        <li class="nav-content">
            <ul>
                ...
                <li class="recharge <?= ('user/userbank/recharge' == $action || 'user/recharge/init' == $action || 'user/userbank/recharge-depute' == $action || 'user/recharge/borrower-recharge' == $action) ? 'selected' : '' ?>"><a href="<?= 'user/recharge/borrower-recharge' == $action ? '/user/recharge/borrower-recharge' : '/user/recharge/init'; ?>"><span class="star"></span>充值</a></li>
