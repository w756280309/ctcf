    ...
    <div class="contract-box clearfix">
        <div class="contract-container">
            <div class="contract-container-box">
                ...
                <div class="rules-content">
                    <p>尊敬的客户：</p>
                    <p>您即将受让<?= $loan->title ?>产品（以下简称本产品），受让成功后您将成为本产品的出借者。为了使您更好地了解本产品风险，现向您提供本风险揭示书。请您在实际受让前，充分了解本产品的特点，仔细阅读本风险揭示书和相关发行文件（包括但不限于产品说明书、认购协议、产品转让协议等相关发行、转让文件）的所有条款，并充分理解条款的含义，根据您自身的出借目标、出借经验、财务状况、风险承受能力及其他相关情况，慎重，确保您能够识别和承担本产品可能给您带来的损失。</p>
                    ...
                    <br><p><b>以上并不能揭示您出借本产品的全部风险及市场的全部情形。您在受让前，务必认真阅读转让规则、转让协议以及本产品的产品说明书、认购协议、本风险揭示书等法律文件的全部内容，理解、掌握本产品的特点和所有条款规则，并通过楚天财富网站、交易终端所公布的信息及其他相关公告了解拟出借产品的风险收益特征，确保出借金额占用您可支配收入总额的合理份额，根据自身的风险承受能力和资产状况等谨慎决策，自行承担全部风险。如影响您风险承受能力的因素发生变化，请及时联系楚天财富更新您的风险承受能力评估结果。</b></p>
                </div>
            </div>
        </div>
    </div>
