...
<div class="point_rule">
    ...
    <div class="rule_content">
        <p class="content_top">楚天财富网积分是基于用户回馈计划，为答谢用户长期以来的支持与厚爱而特别推出的一项增值服务。楚天财富网用户可在积分商城自助查询积分数量，使用积分兑换商品，参与积分活动等。</p>
        <div class="item_box">
            <p class="box_title">
            ...
            <ul class="box_content">
                <li>认购理财产品：</li>
                <li>认购楚天财富网理财产品（新手专享标、理财计划、转让的项目不参加）均会产生积分：</li>
                ...
                <li>签到得积分：</li>
                <li>在楚天财富网移动端首页点击“签到有礼”进入签到页面完成每日签到任务，即可获得签到积分。</li>
            </ul>
        </div>
        <div class="item_box">
            <p class="box_title">
            ...
            <ul class="box_content">
                <li>方法一：您可以登录楚天财富网平台查询，在"我的账户-积分商城"中，可查看您当前的线上积分数量；</li>
        ...
        <div class="item_box">
            ...
            <ul class="box_content">
                <li>1. 登录楚天财富网平台进入"积分商城"，选择喜爱的礼品进行兑换；</li>
        ...
        <div class="item_box">
            ...
            <ul class="box_content">
                <li>登录楚天财富网平台，进入"我的账户"-"积分商城"-"已兑换物品"即可查看。</li>
            </ul>
        </div>
        <div class="item_box">
            <p class="box_title">
    ...
    <span class="zhushi">*积分商城最终解释权归楚天财富网所有</span>
</div>