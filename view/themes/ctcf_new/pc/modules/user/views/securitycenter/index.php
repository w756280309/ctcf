...
foreach (['useraccount/safecenter.css?v=1.6'] as $cssFile) {
                ...
                <div class="revise-login-code">
                    <div class="revise-login-bag">
                        ...
                        <?php if (preg_match("/MSIE/", $_SERVER["HTTP_USER_AGENT"])) { ?>
                            <input type="password" id="password" class="input-code" name="EditpassForm[password]" placeholder="请输入原密码" autocomplete="off">
                        <?php } else { ?>
                            <input onfocus="this.type='password'" id="password" class="input-code" name="EditpassForm[password]" placeholder="请输入原密码" autocomplete="off">
                        <?php } ?>
                    </div>
                    ...
                    <div class="revise-login-bag">
                        <span>新密码</span>
                        <?php if (preg_match("/MSIE/", $_SERVER["HTTP_USER_AGENT"])) { ?>
                            <input type="password" id="new_pass" class="input-code" name="EditpassForm[new_pass]" placeholder="请输入6-16位的新密码" maxlength="20" autocomplete="off">
                        <?php } else { ?>
                            <input onfocus="this.type='password'" id="new_pass" class="input-code" name="EditpassForm[new_pass]" placeholder="请输入6-16位的新密码" maxlength="20" autocomplete="off">
                        <?php } ?>
                    </div>
            ...
            <div class="revise-container hide">
                <div class="pay-code">
                    ...
                    <div class="pay-txt">
                        ...
                        <p>移动用户编辑短信发送至106903125212687</p>
                        <p>电信用户编辑短信发送至106901974687</p>
                        <p>联通用户编辑短信发送至106911535687</p>
                    </div>
                </div>
            </div>
        </div>
