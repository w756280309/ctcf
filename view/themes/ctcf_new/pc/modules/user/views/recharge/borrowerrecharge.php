...
<div class="myCoupon-box">
    <div class="bindCard-header">
        ...
        <span class="bindCard-header-font" style="font-size: 16px;color: #434a54;">充值</span>
    </div>
    <div class="myCoupon-content">
        ...
        <h3>请填写充值金额</h3>
        <div class="section">
            <?php $form = ActiveForm::begin(['id' => 'recharge_form', 'action' => '/user/recharge/borrower-apply', 'options' => ['target' => '_blank']]); ?>
            <ul class="wdjf-form">
                <li><div class="wdjf-label">&nbsp;借款账户余额</div> <div class="wdjf-field"><span class="balance"><?= $user_account->available_balance ?></span> 元</div></li>
                ...
                <li class="wdjf-action">
                    <input class="btn btn-primary" type="submit" style="    color: #fff;background-color: #ff6707;width: 65px;border: 0px;border-radius: 0px;" value="充值">
