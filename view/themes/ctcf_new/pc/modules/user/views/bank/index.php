...
$this->registerJsFile(ASSETS_BASE_URI.'ctcf/js/useraccount/bindcard.js?v=20180326', ['depends' => 'frontend\assets\FrontAsset']);
...
<div class="bindCard-box">
    ...
    <div class="bind-middle" style="height: auto; padding-bottom: 20px;">
        ...
        <div class="bind-info">
            ...
            <p id="bankRechargeRefer" style="padding-left: 114px;padding-right: 37px;color:#f44336"></p>
