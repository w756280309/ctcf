...
$this->registerJsFile(ASSETS_BASE_URI . 'js/order.js?v=2017110601', ['depends' => YiiAsset::class]);
...
<!--				</div>-->
	...
	<div class="rules-box" style="display: none">
		<p class="rules-title"><img src="<?= FE_BASE_URI ?>wap/rate-coupon/bid-page/images/icon_close.png" alt="">活动规则
		</p>
