...
<link rel="stylesheet" href="<?= ASSETS_BASE_URI ?>css/tixian.css"/>
    ...
    <div class="row tixian">
        ...
        <div class="col-xs-8 col-sm-6"><?= rtrim(rtrim($user_acount->available_balance, '0'), '.') ?>元</div>
    ...
    <form method="post" class="cmxform" id="form" action="/user/userbank/tixian" data-to="1">
        ...
        <div class="row dan" style="padding-top: 1px;">
            ...
            <div class="col-xs-12 col-sm-10" style="padding: 0">
                ...
                ?>
                <span style="height: auto;">(每月有<?= $drawFreeLimit ?>次免费发起提现的机会，本月您还有<?= $restDrawCount > 0 ? $restDrawCount : 0 ?>次免费机会，之后每笔收取<?= Yii::$app->params['drawFee'] ?>元手续费)</span>
