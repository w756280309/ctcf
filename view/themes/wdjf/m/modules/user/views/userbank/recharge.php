...
<form method="post" class="cmxform" id="form" action="/user/qpay/qrecharge/verify" data-to="1">
    ...
    <?php if ($bank->isDisabled) { ?>
        <div class="note form-bottom" style="font-size: 13px">*当前所绑定银行卡的快捷充值正在维护，您可以用电脑登录网站（www.wenjf.com）进行大额充值。如有疑问请拨打客服电话：<a class="contact-tel" href="tel:<?= Yii::$app->params['platform_info.contact_tel'] ?>"><?= Yii::$app->params['platform_info.contact_tel'] ?></a>。</div>
    <?php } else { ?>
        <div class="note">
            <ul>
...
<a href="/site/udesk" id="btn_udesk_im" class="btn-kefu" style="display:block; margin-bottom: 10%;text-align: center"><img src="<?= FE_BASE_URI ?>wap/new-homepage/images/online-service-blue.png">在线客服</a>
