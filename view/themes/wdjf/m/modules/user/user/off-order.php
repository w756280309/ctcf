...
<div class="row list-title">
    <div class="col-xs-6"><a href="/user/user/myofforder?type=1&back_url=<?= $back ?>" class="<?= 1 === $type ? 'active-trans-title' : '' ?> trans-title">收益中</a></div>
<!--    <div class="col-xs-4"><a href="/user/user/myofforder?type=2&back_url=--><?//= $back ?><!--" class="--><?//= 2 === $type ? 'active-trans-title' : '' ?><!-- trans-title">募集中</a></div>-->
    <div class="col-xs-6"><a href="/user/user/myofforder?type=3&back_url=<?= $back ?>" class="<?= 3 === $type ? 'active-trans-title' : '' ?> trans-title">已还清</a></div>
</div>
<?php if(!empty($model))  { ?>
