...
<div class="row kongxi">
    ...
    <?php $form = ActiveForm::begin(['id' => 'signup_form', 'action' => $actionUrl]); ?>
        ...
        <div class="col-xs-9 col">
            <input id="pass" class="login-info" name="" maxlength="20" type="password" placeholder="请输入6到20位的密码" autocomplete="off" onfocus="this.type='password'">
            <input id="pass2" class="login-info" name="SignupForm[password]" maxlength="20" type="hidden" placeholder="请输入6到20位的密码" autocomplete="off">
        </div>
