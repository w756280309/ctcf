...
<div>
    ...
    <p>
        <span>丙方：</span>
        <span>温州温都金融信息服务股份有限公司</span>
    </p>
    <p>
        <span>法定代表人：周向勇</span>
    </p>
    <p>
        <span>注册地址：温州市鹿城区公园路105号新闻大楼402室</span>
    </p>
    <p>
        <span style="font-weight:bold">鉴于：</span>
    </p>
    <p class="text_index">
        <span>甲方于<?= $loanOrderCreateDate ?>，通过丙方运营互联网金融平台（包括名为“温都金服”、网址为</span>
        <a style="color:#0563c1" href="https://www.wenjf.com/"><span style="text-decoration:underline">https://www.wenjf.com</span></a>
        <span>的网站和名为“温都金服”的手机APP；下称“温都金服”）认购<?= $loanTitle ?>产品（以下简称本产品），认购金额为<?= $loanOrderPrincipal ?>元。截至该产品的转让之日，该产品尚未到期。</span>
    </p>
    <p class="text_index">
        <span>现甲方由于自身原因，拟通过温都金服向其他合格投资者（包括个人投资者和机构投资者）部分/全部转让其所持有的本产品（本产品的相关合同中不含有禁止转让条款），甲方拟转让本产品的投资本金金额（以下简称“转让金额”）为<?= $creditOrderPrincipal ?>元（本产品的起购金额≤<?= $creditOrderPrincipal ?>≤<?= $loanOrderPrincipal ?>）。</span>
    </p>
    ...
    <p class="text_index"><span>乙方系符合本产品的合格投资者标准的温都金服的注册会员，且乙方同意受让甲方拟转让的本产品。乙方已完整阅读拟受让的本产品的《产品说明书》、《产品认购协议》、《产品风险揭示书》等相关产品合同，完全理解该产品的类型、性质及受让后果，对该产品可能发生的风险有足够的了解和认识并愿意自行承担投资该产品可能带来的财产损益和法律责任。</span>
    </p>
    <p class="text_index"><span>“产品转让服务”仅为温都金服向甲方（转让方）和乙方（受让方）提供的中介服务。本次产品转让活动涉及资金和权益的处分，由此带来的任何风险包括潜在风险需要甲方和乙方自行判断和承担。</span>
    </p>
    ...
    <p class="text_index">
        <span>甲方在温都金服网页以点击确认的形式向合格投资者发出的部分/全部转让所持有本产品之要约，乙方在温都金服网页以点击确认的形式签署本转让协议且成功支付转让价款的，视为向甲方发出的受让甲方持有的部分/全部本产品要约之承诺，本转让协议生效。
        </span>
    </p>
    <p class="text_index">
        <span>四、相关风险揭示</span>
    ...
    <p class="text_index">
        <span>4.1.1 损失部分利息风险。温都金服转让规则规定，根据转让人设定的折让率计算所得的转让价款不得低于转让金额（转让金额为转让人拟转让的投资本金，折让率是指产品在转让时折让的比率）。因此，如果您设定的折让率为零，您不会因转让行为损失投资本金和根据合同约定所计算的自收益起算日至转让成功日期间的投资收益；但如果您设定的折让率大于零，您将损失部分投资收益。</span>
    </p>
    <p class="text_index">
        <span>4.1.2 转让失败风险。温都金服仅为转让人和受让人提供中介服务，并不承诺保证每一个转让申请都能全部/部分成功完成转让。因此，在转让申请时效内，甲方可能面临全部/部分产品转让失败的风险。</span>
    </p>
    <p class="text_index">
    ...
    <p class="text_index">
        <span>5.1 乙方在温都金服以点击形式签署本协议并成功支付转让价款之日起成为继受的产品持有人，享有</span>
        <span><?= $loanTitle ?></span>
