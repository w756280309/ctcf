 ...
 */
class Logger extends \yii\db\ActiveRecord implements \PayGate\Ump\LoggerInterface
{
    /**
     * {@inheritdoc}
     */
     ...
     * return tradelog 对象
     */
    public function initLog($direction = 1, $rqData = null, $rq = null, $rp = null, $duration = 0)
    {
        $uid = 0;
