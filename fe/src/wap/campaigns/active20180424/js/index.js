    ...
    var states = {
        loading: function () {
            ...
            this.preload = function () {
                ...
                game.load.image('process', 'images/processing.png');
                game.load.image('processBg', 'images/process_bg.png');
            };
        ...
        preload: function () {
            //预加载阶段
            this.preload = function () {
                game.load.image('one', 'images/1@2x.png');
                game.load.image('two', 'images/2@2x.png');
                game.load.image('three', 'images/3@2x.png');
                game.load.image('start', 'images/bg.png');
                game.load.image('award', 'images/award.png');
                game.load.image('noaward', 'images/no-award.png');
                ...
                game.load.image('redpacket', 'images/red.png');
                game.load.image('yellowpacket', 'images/yellow.png');
