...
redPack.prototype.create = function(id, className) {
    var el = this.el,
    This = this,
    flag = true,
    ...
    nRed.setAttribute("redClassName",className);
    nRed.className = className;
	...
	document.addEventListener('touchstart', function(e){
        if (e.target.className === 'redpack' || e.target.className === 'gold-redpack') {
            handler(e);
