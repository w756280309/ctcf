...
class HttpSignUtils{
	...
	static function createHttpSign($bodyParams,$timestamp=null){
		...
		$contactStr.="appKey".\Yii::$app->params['bao_quan_config']['app_key'];
		$contactStr.="appSecret".\Yii::$app->params['bao_quan_config']['app_secret'];
	...
	static function createHeaderStr($contentType="application/x-www-form-urlencoded;charset=UTF-8"){
		$contactStr="";
		//其它信息
		$contactStr=$contactStr.'appKey:'.\Yii::$app->params['bao_quan_config']['app_key']."\r\n";
