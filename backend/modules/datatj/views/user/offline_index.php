        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="javascript:void(0);">线下复投新增数据统计</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="portlet-body">
            <form action="" method="get" target="_self">
                <table class="table">
                    <tr>
                        <td>
                            <span class="title">统计月份范围</span>
                        </td>
                        <td>
                            <input type="text" placeholder="统计开始月份" value="<?= Html::encode($monthStart) ?>"
                                autocomplete="off"
                                name="monthStart" class="m-wrap"
                                onclick="WdatePicker({dateFmt: 'yyyy-MM', maxDate: '%y-{%M-1}'})">-
                            <input type="text" placeholder="统计结束月份" value="<?= Html::encode($monthEnd) ?>"
                                   autocomplete="off"
                                   name="monthEnd" class="m-wrap"
                                   onclick="WdatePicker({dateFmt: 'yyyy-MM', maxDate: '%y-{%M-1}'})">
                        </td>
                        <td>
                ...
                GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'format' => 'html',
                            'value' => function ($data) {
                                return '<a href="/user/offline/detail?id='.$data['id'].'">'.$data['realName'].'</a>';
                            }
                        ],
                        [
                            'label' => '客户手机号',
                            'value' => function ($data) {
                                return StringUtils::obfsMobileNumber($data['mobile']);
                            },
                        ],
                        [
                            'label' => '老客复投金额（元）',
