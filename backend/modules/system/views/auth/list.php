    ...
    <div class="row-fluid">
        <div class="span12">            
                <h3 class="page-title">
                        ...
                        <a href="/system/auth/edit" id="sample_editable_1_new" class="btn green" style="float: right;">
                            ...
                            <?php foreach ($model as $key => $val) : ?>
                                <tr>
                                        ...
                                        <td style="text-align: center">
                                            <a href="/system/auth/edit?id=<?= $val['id'] ?>" class="btn mini green"><i class="icon-edit"></i> 编辑</a>
                                             |
...
<script type="text/javascript">
    jQuery(document).ready(function () {
        $('.ajax_op').bind('click', function () {
            ...
            $.get("/system/auth/activedo", {op: op, value: data_index, id: index}, function (result) {
                cloaseLoading()
                newalert(result,'',1);
            });
        });
