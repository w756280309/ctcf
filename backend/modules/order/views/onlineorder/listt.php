        ...
        <div class="span12">
            ...
            <ul class="breadcrumb">
                   <li>
                    ...
                    <li>
                        <a href="/user/user/detail?id=<?= $user->id ?>&type=1">会员详情</a>
                        <i class="icon-angle-right"></i>
                    </li>
                    <li>
        ...
        <div class="portlet-body">
            <table class="table">
                    <tr>
                        ...
                        <td>
                            <span class="title">投资金额总计（元）：<?= StringUtils::amountFormat3($moneyTotal) ?></span>
                        </td>
                        <td>
            ...
            <table class="table table-striped table-bordered table-advance table-hover">
                ...
                <?php foreach ($model as $key => $val) : ?>
                    <tr>
                        <td><?= $val['sn'] ?></td>
                        <td><?= $res[$val['id']] ?></td>
                        <td><?= StringUtils::amountFormat3($val['order_money']) ?></td>
                        <td><?= StringUtils::amountFormat3($val['couponAmount']) ?></td>
