...
<?php $this->beginBlock('blockmain'); ?>
    ...
    <div class="row-fluid">
        ...
        $form = ActiveForm::begin([
            'action' => '/user/point/add?userId='.$userId.'&isOffline='.$isOffline,
            'options' => [
        ...
        <div class="portlet-body form">
            <div class="control-group">
                ...
                <div class="controls">
                    <?= $form->field($PointRecord, 'remark', ['template' => '{input}<span class="notice">*最多填写6个汉字</span>', 'inputOptions' => ['autocomplete' => 'off', 'placeholder' => '发放积分描述']])->textInput() ?>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?= $form->field($PointRecord, 'incr_points', ['template' => '{input}', 'inputOptions' => ['autocomplete' => 'off', 'placeholder' => '发放积分数额']])->textInput() ?>
            ...
            <div class="form-actions">
                ...
                <a href="<?= $isOffline === 0 ? '/user/user/detail?id='.$userId.'&type=1' : '/user/offline/detail?id='.$userId ?>" class="btn">取消</a>
            </div>
        </div>
        <?php $form->end(); ?>
    </div>
