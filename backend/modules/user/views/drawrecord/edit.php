...
<div class="container-fluid">
    ...
    <div class="row-fluid">
        <div class="span12">
            <h3 class="page-title">
                        会员管理 <small>会员提现管理模块【主要包含融资会员的提现数据的录入】</small>
            </h3>
            <ul class="breadcrumb">
                    <li>
                        <i class="icon-home"></i>
                    ...
                    <li>
                        <a href="javascript:void(0);">提现流水明细录入</a>
                    </li>
            </ul>            
        </div>
      ...
      <?php $form = ActiveForm::begin(['id' => 'adv_form', 'action' => "/user/drawrecord/edit?id=$id&type=$type",'options' => ['class'=>'form-horizontal form-bordered form-label-stripped']]); ?>             
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?=
            $form->field($model, 'bank_id', ['template' => '{input}{error}', 'inputOptions'=>['autocomplete'=>"off",'class'=>'chosen-with-diselect span6']])->dropDownList($banks)
         ?>
        </div>
    </div>
    <div class="control-group">
        ...
        <div class="controls">
            <?= $form->field($model, 'money', ['template' => '{input}', 'inputOptions'=>['autocomplete'=>"off",'class'=>'m-wrap span12','placeholder'=>'提现金额']])->textInput() ?>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="text" value="" name = "created_at" onclick='WdatePicker({dateFmt:"yyyy-MM-dd",maxDate:"<?=  date('Y-m-d')?>"});'/>   
        </div>
    </div>
