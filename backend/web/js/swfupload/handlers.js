	...
	try {
		...
		//t 0->adv 1->product
			...
			addImage("/upload/product/" + serverData.substring(7),"FILEIB");
                        ...
                        document.getElementById('hidimage').value=serverData.substring(7);
                       addImage("/upload/adv/" + serverData.substring(7),"FILEIB"); 
                    }else{
                       addImage("/upload/product/" + serverData.substring(7),"FILEIB"); 
                    }
//			imgname=serverData.substring(7);
//			$("#thumbnails_baoli").append("<div><input type='text' name='name[]' value='"+imgname+"' /><input type='hidden' name='content[]' value='"+imgname+"' /><br><input type='hidden' name='field_type[]' value='2' /></div>");
...
//            newImg.addEventListener('click', delimg(0,src), false); 
//            newImg.addEventListener('click', delimg(0,src), false); 
//        } else { // IE 
//            newImg.attachEvent('onclick',  function(){delimg(0,src);}); 
//            newImg.attachEvent('onclick',  function(){delimg(0,src);}); 
//        } 
	if(status=='FILEID')
	{
