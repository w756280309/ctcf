			...
			if(arr.length){ 
				...
				if(d){
                   ...
                   var dd=d;
                                         ...
                                         var dt=this.Year+"-"+month2+"-"+dd;
                                      //  var url='?start_date='+dt+'&end_date='+dt;
                                      //  var aa = "<a href='#' onclick=\"window,location.href='"+url+"';\">" +d + "</a>";
					cell.innerHTML = "<a href='?start_date="+dt+"&end_date="+dt+"' >"+d+"</a>";
					this.Days[d] = cell;
