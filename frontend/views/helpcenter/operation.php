        ...
        <div class="rightcontent">
            ...
            <div class="help-box">
                ...
                <div class="kong-width">
                    ...
                    <p>用户登录后，进入“我的账户”－&gt;“安全中心”－&gt;“我的银行卡”－&gt;点击“更换银行卡”，在换卡申请页面，根据“换卡提醒”进行相关操作，完成更换银行卡的申请。在办理换卡过程中，如有疑问请拨打客服热线<?= \Yii::$app->params['contact_tel'] ?>。
                    </p>
                    <p class="single-tuchu">6、换卡申请提交后，多久可以换卡成功？
                    </p>
                    <p>若您的账户余额为0且没有在途资金，系统将在一小时以内自动审核换卡；否则需拨打客服热线<?= \Yii::$app->params['contact_tel'] ?>提交相关资料，提交资料后，进行2-5天的人工审核换卡；在途资金指有投资回款或提现冻结金额。换卡申请期间不影响充值和提现。
                    </p>
                ...
                <div class="kong-width">
                    ...
                    <p>提现每日最高100万，超过100万需要临时提升限额或分多日提现，如需提升限额请联系客服，电话<?= Yii::$app->params['contact_tel'] ?>。
