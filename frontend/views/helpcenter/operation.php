        ...
        <div class="rightcontent">
            ...
            <div class="help-box">
                ...
                <div class="kong-width">
                    ...
                    <p>若您的账户余额为0且没有在途资金，系统将在半小时以内自动审核换卡；否则需拨打客服热线<?= \Yii::$app->params['contact_tel'] ?>提交相关资料，提交资料后，进行2-5天的人工审核换卡；在途资金指有投资回款或提现冻结金额。换卡申请期间不影响充值和提现。
                    </p>
                ...
                <div class="kong-width">
                    ...
                    <p>已购项目持有30天后即可进行转让；持有天数从计息日开始计算；付息日和还款日前3天不可转让。
                    </p>
