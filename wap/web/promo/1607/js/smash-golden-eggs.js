                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.code == 101) { //登录后再砸吧
                                ...
                                $('.card-title span').html(data.name);
                                $('.mark-box').fadeIn();
                                $('.card-box').show();
                                setTimeout(function () {
                                ...
                                } else if (data.type == 2) {//888元礼包
                                    $('.card-btn span').html('查看奖品');
                                    $('.card-title').css({top: '46%'});
                                    $('.card-content').hide();
                                    $('.card-title i').html('一份');
                                    $('.card-btn').attr({href: '/user/coupon/list'});
                                } else if (data.type == 3) { //京东卡
                                ...
                                } else if (data.type == 4) { //再抽一次
                                    $('.card-btn span').html('确认');
                                    $('.card-title').css({top: '46%'});
                                    $('.card-content').hide();
                                    $('.card-title i').html('的机会');
                                    $('.card-btn span').on('click', function () {
                                        $('.card-box').removeClass('card-box1');
                                        setTimeout(function () {
                                            $('.card-box').hide();
