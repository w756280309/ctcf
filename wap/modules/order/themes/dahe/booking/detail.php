...
<div class="container" style="background: #fff;">
    ...
    <div class="row" style="padding:0; margin:15px 0 50px;" >
        <ul class="col-xs-12" style="padding:0 25px; ">
            <li >
                <div class="color2 p1">
                    <p class="tit"><a href="javascript:;" class="a1" ></a><span class="color1">股权项目介绍</span></p>
                    <p>大河阳光理财甄选优秀的股权投资基金管理机构，为市民家庭提供良好的股权投资机会，推出“股权项目”系列产品。以私募基金形式，向合资格投资者定向非公开开放。</p>
                </div>
            </li>
            <li >
                <div class="color2 p1">
                    <p class="tit"><a href="javascript:;" class="a1" ></a><span class="color1">投资方向</span></p>
                    <p>第一期股权项目产品，投向中国一二线城市的优秀青年白领公寓企业，分享中国城市青年租房需求升级的红利。</p>
                </div>
            </li>
            <li >
                <div class="color2 p1">
            ...
            <li >
                <div class="color2 p1 p2">
                    ...
                    <p>正规持牌备案，合法合规运行，投资能力卓越。收房租，好生意。股权项目，只投稳妥的股权。有意者，请点击预约登记。专业投资机构将派专人为您服务。</p>
                </div>
            </li>
