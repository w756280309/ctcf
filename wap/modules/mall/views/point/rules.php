...
<section>
    <p class="intro">温都金服积分是基于用户回馈计划，为答谢用户长期以来的支持与厚爱而特别推出的一项增值服务。温都金服用户可在积分商城自助查询积分数量，使用积分兑换商品，参与积分活动等。</p>
    <div class="content">
        <ul>
            <li><img src="<?= FE_BASE_URI ?>wap/point/img/icon_01.png" alt="">怎么获得积分</li>
            <li>认购理财产品：</li>
            <li>从2017年1月1日起，认购温都金服理财产品（新手专享标、理财计划、转让的项目不参加）均会产生积分：</li>
            ...
            <li>签到得积分：</li>
            <li style="text-indent: 1em;">在温都金服移动端首页点击“签到有礼”进入签到页面完成每日签到任务，或直接进入“积分商城”自动签到即可获得签到积分。</li>
        </ul>

        <ul>
            <li><img src="<?= FE_BASE_URI ?>wap/point/img/icon_02.png" alt="">如何查询我的积分</li>
            <li>方法一：您可以登录温都金服平台查询，在"我的账户-我的积分"中，可查看您当前的线上积分数量；</li>
            <li>方法二：线下客户拨打客服热线<a href="tel:400-101-5151">400-101-5151</a>查询您当前个人的积分数量。</li>
        </ul>

        <ul>
            <li><img src="<?= FE_BASE_URI ?>wap/point/img/icon_03.png" alt="">积分如何换购商品</li>
            <li style="text-indent: 1em;">1.  登录温都金服平台进入“积分商城”，选择喜爱的礼品进行兑换；</li>
            <li style="text-indent: 1em;">2.  线下客户通过线下服务点申请办理兑换。</li>
            <li>礼品一旦兑换成功不能更改，如有问题请联系客服人员：<a href="tel:400-101-5151">400-101-5151</a>。</li>
            <li>不同账户积分不可合并使用。</li>
        </ul>

        <ul>
            <li><img src="<?= FE_BASE_URI ?>wap/point/img/icon_04.png" alt="">如何查询已兑换的商品订单</li>
            <li>登录温都金服平台，进入“我的账户”-“我的积分”-“兑换记录”即可查看。</li>
        </ul>
