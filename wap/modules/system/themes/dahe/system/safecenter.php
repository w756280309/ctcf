...
<?php if($user_bank){ ?>
    <a class="row sm-height border-bottom visit" style="display: block;" href="<?= $user_bank instanceof QpayBinding && (int)$user_bank->status !== 3 ? '/user/bank/card' : 'javascript:void(0)' ?>">
