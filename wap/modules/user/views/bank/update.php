...
<div class="row tishi">
    <div class="col-xs-12">*换卡请先咨询客服热线<?= Yii::$app->params['contact_tel'] ?></div>
</div>
...
<form method="post" class="cmxform" id="form" action="/user/bank/update-verify" data-to="1">
    ...
    <div class="row replacecard-tixin">
        <div class="col-xs-12">
            ...
            <div>若您的账户余额为0且没有在途资金，系统将在半小时以内自动审核换卡；否则需拨打客服热线<a class="contact-tel" href="tel:<?= Yii::$app->params['contact_tel'] ?>"><?= Yii::$app->params['contact_tel'] ?></a>提交相关资料，提交资料后，进行2-5天的人工审核换卡；</div>
