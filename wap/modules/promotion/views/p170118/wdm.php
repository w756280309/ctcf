...
<link rel="stylesheet" href="<?= FE_BASE_URI ?>wap/common/css/base.css?v=20170119">
...
<div class="container flex-content" id="scrolltop">
    ...
    <div class="choosereason">
        <p class="f18 "><img  data-original="<?= FE_BASE_URI ?>wap/wendumao/images/icon_01.png" alt=""> 为什么选择国资平台-温都金服 <img  data-original="<?= FE_BASE_URI ?>wap/wendumao/images/icon_01.png" alt=""></p>
    ...
    <div class="newnorm">
        ...
        <a href="/deal/deal/index">
            ...
            <p class="f12">预期年化率</p>
            <ul class="clearfix">
                <li class="f14 lf text-align-lf"><img class="icon5"  data-original="<?= FE_BASE_URI ?>wap/wendumao/images/icon_05.png" alt=""> 1,000元起投</li>
        ...
        <p class="f15 intro"><img  data-original="<?= FE_BASE_URI ?>wap/wendumao/images/icon_02.png" alt=""> 温都金服历史兑付率100%</p>
    </div>
