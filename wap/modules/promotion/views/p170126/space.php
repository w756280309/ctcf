...
<div class="container flex-content" id="scrolltop">
    ...
    <div class="regular">
        <ul class="f15">
            <li>活动规则：</li>
            <li>1.注册送288元红包；</li>
            <li>2.2017年1月26日起首次投资，送积分1400分，可兑换星际嘉年华亲子套票一份；</li>
            <li>3.2017年1月26日起首次投资5万以上，送积分3500分，可以在积分商城兑换其他产品；</li>
            <li>4.星际嘉年华亲子套票领取地址：温州市鹿城区飞霞南路657号保丰大楼四层；</li>
            <li>5.活动时间：1月26日至3月10日；</li>
            <li>6.如发现一人注册多个账户、刷单等恶意行为，温都金服有权取消活动资格。</li>
        ...
        $('.phonenum a').on('click',function() {
            ...
            if (phonenum.length < 11) {
                ...
                if (moduleFn.check.mobile(phonenum)) {
                    var xhr = $.get('/promotion/p170126/validate-mobile?mobile='+phonenum);
