...
$next = Yii::$app->request->hostInfo.'/promotion/p1705/duobao2';
...
<div class="flex-content">
    ...
    <div class="gift">
        ...
        <div class="progress">
            ...
            <div class="totalNum clearfix"><span class="lf">总需1000人</span><span class="rg">剩余<i><?= 1000 - $totalTicketCount ?></i></span></div>
...
<script>
    $(function () {
        ...
        $(".join-btn").on("click", function(e) {
            ...
            var xhr = $.get('/promotion/p1705/duobao2');
            allowClick = false;
