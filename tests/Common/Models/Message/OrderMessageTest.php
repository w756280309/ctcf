...
//            ],
            [
                'first' => ['尊敬的客户，您于'.date('Y-m-d H:i:s', $onlineOrder->order_time).'在温都金服成功投资。', 'black'],
                'keyword1' => ['超级测试标', 'black'],
                'keyword2' => ['10%', 'black'],
                'keyword3' => ['365天', 'black'],
                'keyword4' => ['10,000.00元', 'black'],
                'keyword5' => ['1,000.00元', 'black'],
                'remark' => ['感谢您的投资，点击查看详情，如有疑问请致电：400-101-5151进行咨询。', 'black'],
            ],
            \Yii::$app->params['clientOption']['host']['wap'].'deal/deal/detail?sn=DK201700004233',
            \Yii::$app->params['order_message_template_id'],
